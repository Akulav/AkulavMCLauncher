...
namespace AkulavLauncher
{
    class Paths
    {
        ...
        public static readonly string akulav_launcher_config = Path.Combine(mc, "AkulavLauncherConfig");

        // Files and URLs
        public static readonly string localMetadata = Path.Combine(akulav_launcher_config, "modpacks_local.json");
        public static readonly string settings = Path.Combine(akulav_launcher_config, "akulav_launcher_settings.json");
        public static readonly string links = Path.Combine(akulav_launcher_config, "links.json");
